...
const teamsDetailsContact1Name = $('#teamsDetailsContact1Name');
const teamsDetailsContact1Phone = $('#teamsDetailsContact1Phone');
const teamsDetailsContact1Email = $('#teamsDetailsContact1Email');
const teamsDetailsContact1Alias = $('#teamsDetailsContact1Alias');
const teamsDetailsContact2Name = $('#teamsDetailsContact2Name');
const teamsDetailsContact2Phone = $('#teamsDetailsContact2Phone');
const teamsDetailsContact2Email = $('#teamsDetailsContact2Email');
const teamsDetailsContact2Alias = $('#teamsDetailsContact2Alias');
const teamsDetailsContact3Name = $('#teamsDetailsContact3Name');
const teamsDetailsContact3Phone = $('#teamsDetailsContact3Phone');
const teamsDetailsContact3Email = $('#teamsDetailsContact3Email');
const teamsDetailsContact3Alias = $('#teamsDetailsContact3Alias');
...
const intermsDetailsNumber = $('#intermsDetailsNumber');
const intermsDetailsErp = $('#intermsDetailsErp');
